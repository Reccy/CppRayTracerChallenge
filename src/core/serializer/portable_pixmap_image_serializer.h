#ifndef _CPPRAYTRACERCHALLENGE_CORE_IO_PORTABLE_PIXMAP_IMAGE_SERIALIZER
#define _CPPRAYTRACERCHALLENGE_CORE_IO_PORTABLE_PIXMAP_IMAGE_SERIALIZER
...
#endif _CPPRAYTRACERCHALLENGE_CORE_IO_PORTABLE_PIXMAP_IMAGE_SERIALIZER
