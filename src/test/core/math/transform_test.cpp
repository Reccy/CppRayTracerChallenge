...
namespace CppRayTracerChallenge::Core::Math
{
	...
	{
		double rotationAmount = RML::Trig::radians_to_degrees(RML::Trig::PI / 2);
	...
	{
		double rotationAmount = RML::Trig::radians_to_degrees(RML::Trig::PI / 4);
	...
	TEST(CppRayTracerChallenge_Core_Math_Transform, individual_transformations_are_applied_in_sequence)
	{
		...
		Transform a = Transform()
			.rotate(RML::Trig::radians_to_degrees(RML::Trig::PI / 2), 0, 0);
